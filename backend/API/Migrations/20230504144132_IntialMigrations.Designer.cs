...
namespace API.Migrations
{
    ...
    [Migration("20230504144132_IntialMigrations")]
            ...
            modelBuilder.Entity("API.Models.MovieCinema", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_movie_cinema");

                    b.ToTable("movie_cinema", (string)null);
                });
            ...
            modelBuilder.Entity("API.Models.MovieCinemasMovies", b =>
                {
                    b.HasOne("API.Models.MovieCinema", "MovieCinema")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_movie_cinemas_movies_movie_cinema_movie_cinema_id");
